import {o as De, t as ye} from "../chunks/scheduler.69c11db5.js";
import {S as He, a as Je, I as V, g as Ce, f as Ve, b as we, c as le, s as M, d as ee, i as _e, e as J, P as qe, h as We} from "../chunks/singletons.2572eeef.js";
function Xe(t, o) {
...
window.fetch = (t,o)=>((t instanceof Request ? t.method : (o == null ? void 0 : o.method) || "GET") !== "GET" && ne.delete(Se(t)),
fe(t, o));
const ne = new Map;
function it(t, o) {
    const u = Se(t, o)
    ...
    return {
        pattern: t === "/" ? /^\/$/ : new RegExp(`^${ut(t).map(i=>{
            ...
            return "/" + S.map((w,_)=>{
                if (_ % 2) {
                    if (w.startsWith("x+"))
                        return be(String.fromCharCode(parseInt(w.slice(2), 16)));
                    if (w.startsWith("u+"))
                        return be(String.fromCharCode(...w.slice(2).split("-").map(P=>parseInt(P, 16))));
                    const p = ct.exec(w);
                    if (!p)
                        throw new Error(`Invalid param: ${w}. Params and matcher names can only have underscores and alphanumeric characters.`);
                    const [,D,x,k,N] = p;
                    return o.push({
                        name: k,
                        matcher: N,
...
function dt(t, o, u) {
    ...
    for (let S = 0; S < o.length; S += 1) {
        const l = o[S];
        let w = d[S - f];
        if (l.chained && l.rest && f && (w = d.slice(S - f, S + 1).filter(_=>_).join("/"),
        f = 0),
        w === void 0) {
            l.rest && (i[l.name] = "");
            continue
...
function Rt(t, o) {
    ...
    async function Le(e) {
        return w = {
            id: e.id,
            promise: he(e).then(n=>(n.type === "loaded" && n.state.error && (w = null),
            n))
        },
        w.promise
    }
    ...
    function Oe(e) {
        ...
        _.after_navigate.forEach(s=>s(r)),
        x = !0
    }
    async function W({url: e, params: n, branch: r, status: a, error: s, route: c, form: g}) {
        let m = "never";
        for (const b of r)
    ...
    function xe({url: e, type: n, intent: r, delta: a}) {
        ...
        return P || _.before_navigate.forEach(y=>y(g)),
        s ? null : c
    }
    async function ce({url: e, scroll: n, keepfocus: r, redirect_chain: a, details: s, type: c, delta: g, nav_token: m={}, accepted: v, blocked: y}) {
        ...
        if (b.type === "redirect")
            if (a.length > 10 || a.includes(e.pathname))
                ...
                return re(new URL(b.location,e).href, {}, [...a, e.pathname], m),
                !1;
        else
            (($ = b.props.page) == null ? void 0 : $.status) >= 400 && await M.updated.check() && await G(e);
        if (S.length = 0,
        B = !1,
        N = !0,
        ve(O),
        Re(O),
        (C = b.props.page) != null && C.url && b.props.page.url.pathname !== e.pathname && (e.pathname = (E = b.props.page) == null ? void 0 : E.url.pathname),
        s) {
...
async function Be(t, o) {
    ...
    if (!i.ok)
        throw new te(i.status,await i.json());
